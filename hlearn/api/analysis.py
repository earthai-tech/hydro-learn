...
def nPCA(
    ...
    **pca_kws
    ...
    Examples
    ---------
    >>> from hlearn.analysis.dimensionality import nPCA
...
def iPCA(
    ...
    **ipca_kws
    ...
    Examples
    ---------
    >>> from hlearn.analysis.dimensionality import iPCA
    >>> from hlearn.datasets import fetch_data 
...
def kPCA(
    ...
    **kpca_kws
    ...
    Examples
    ----------
    >>> from hlearn.analysis.dimensionality import kPCA
    >>> from hlearn.datasets import fetch_data 
...
def LLE(
    ...
    **lle_kws
    ...
    Example
    -------
    >>> from hlearn.analysis.dimensionality import LLE
    >>> from hlearn.datasets import fetch_data 
    >>> X, _=fetch_data('Bagoue analysed data')
    >>> lle_kws ={
    ...    'n_components': 4, 
