...
class DSBoreholes:
    ...
    `hole.<holeid>.<data_column>`: :class:`~hlearn.utils.box.Boxspace` 
    ...
    ---------
    >>> import hlearn as wx 
    >>> from hlearn.geology import DSBoreholes 
    ...
    def fit ( self, data, **fit_params): 
        ...
        fit_params: dict,
          Keyword arguments passed to :func:`hlearn.to_numeric_dtypes` to 
          sanitize the data. 
...
class DSBorehole: 
    ...
    :class:`hlearn.geology.drilling.DSBorehole` works with data collected in 
    a single borehole. For instance, it could follow the arrangement of 
    ``h502`` data in :func:`hlearn.datasets.load_hlogs`
    ...
    ----------
    >>> import hlearn as wx 
    >>> from hlearn.geology import DSBorehole 
    ...
    def fit(self, data,  **fit_params ):
        ...
        fit_params: dict, 
           Keyword arguments passed to :func:`hlearn.utils.to_numeric_dtypes`
           for data management. 
...
class _drill_builder: 
    ...
    attributes should be::
        ...
        >>> from hlearn.geology.drilling import _drill_builder
    ...
    ----------
    >>> from hlearn.geology.drilling import _drill_builder
    >>> from hlearn.datasets import load_nlogs 
...
class DSDrill (GeoBase) : 
   ...
   properties: dict, 
    ...
    def fit (self, data =None, **fit_params ): 
        ...
        Examples 
        -----------
        >>> from hlearn.geology.drilling import Drill 
    ...
    def get_collar (self, data =None, reset_collar =False , **kws ): 
        ...
        kws: dict, 
           Keyword arguments passed to :func:`hlearn.utils.coreutils._is_readable`
        ...
        Examples
        ---------
        >>> from hlearn.geology.drilling import DSDrill 
        >>> xlsx_data= 'data/drill/nbleDH.xlsx'
    ...
    def build_geosamples( self, *, return_data=False , **kwd): 
        ...
        - samples thickness: Ask the thickness of the samples in the whole. 
          ...
          - Note that any mixed types is not acceptable and willraises error.
            ...
            use the following :func:`hlearn.utils.geotools.get_thick_from_range` 
            or :func:`hlearn.utils.geotools.get_thick_from_values` functions.
    ...
    def get_properties (self, kind: str ): 
        ...
        Examples 
        -----------
        >>> from hlearn.geology import DSDrill 
    ...
    def build_drillholes( 
        ...
        - samples: 
          ...
          - Note that any mixed types is not acceptable and willraises 
            ...
            :func:`hlearn.utils.geotools.get_thick_from_range` 
            or :func:`hlearn.utils.geotools.get_thick_from_values` functions.
