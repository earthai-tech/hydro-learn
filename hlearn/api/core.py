...
EMOD = 'hlearn.etc' ; buffer_file = 'AGSO.csv'
with resources.path (EMOD, buffer_file) as buff : 
     props_buf  = str(buff) 
AGSO_PROPERTIES =dict(
    GIT_REPO = 'https://github.com/WEgeophysics/hlearn', 
    GIT_ROOT ='https://raw.githubusercontent.com/WEgeophysics/hlearn/master/',
...
class GeoBase: 
    ...
    def find_properties(
        ...
        Examples
        ---------
        >>> from hlearn.geology.core import GeoBase 
...
def get_agso_properties(config_file =None, orient ='series'): 
    """ Get the geostructures files from <'hlearn/etc/'> and 
    ...
    :Example: 
        >>> import hlearn.geology.core import get_agso_properties
        >>> data=get_agso_properties('hlearn/etc/AGSO_STCODES.csv')
