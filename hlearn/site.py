...
from .utils.baseutils import makeCoords 
...
class Profile: 
    ...
    def distance (self, *, average_distance: bool = True): 
        ...
        See Also 
        ---------
        hlearn.utils.exmath.get_distance: 
        ...
        --------- 
        >>> import numpy as np 
        >>> from hlearn.site import Profile 
    ...
    def scale_positions (self, **sp_kws): 
        ...
        -----------
        sp_kws: dict 
           Keyword arguments passed to :func:`~hlearn.utils.scalePosition`. 
        ...
        See also 
        ---------
        hlearn.utils.scalePositions: 
            Scale positions using the `scipy` curve fit. 
        hlearn.utils.exmath.scale_positions: 
        ...
        *, 
        ...
        if self.coordinate_system !='utm': 
            ...
            warnings.warn((
                ...
                " positions data to UTM (ref:`hlearn.site.to_utm_in`) before"
    ...
    def f_ (ar , /,  func: str | F  = 'dms->ll'): 
        ...
        func: Callable or str, default ='dms->ll'
            ...
            - :func:`~hlearn.utils.gistools.convert_position_str2float` 
              for ``:dd:mm:ss``  to foat(long, lat) coordinates. If 
              string is passed it should be ['dms2ll'|'dmstoll'|'dms-<ll']. 
            - :func:`~hlearn.utils.gistools.convert_position_float2str` 
    ...
    def make_xy_coordinates (
        ...
        **kws 
        ...
        kws: dict, 
           Additional keywords of :func:`~hlearn.utils.exmath.makeCoords`.   
        ...
        See Also 
        --------
        hlearn.utils.coreutils.makeCoords: 
    ...
    def interpolate(
        ...
        **kws
        ...
        kws: dict,
           ...
           :func:`~hlearn.utils.funcutils.interpolate_grid`. 
           
        Returns
        --------
        self|x, y, elev: :class:`~hlearn.site.Profile` or Arraylikes 
           `:class:`.Profile` objects if `inplace` is ``True`` or 
           interpolated x, y and elev. 
           
        See Also 
        --------
        hlearn.utils.funcutils.interpolate_grid: 
    ...
    def plot (
        ...
        **kws): 
        ...
        kws: dict, 
           ...
           :func:`~hlearn.utils.plotutils.plot_text`
...
Examples 
--------- 
>>> from hlearn.datasets import load_edis
>>> from hlearn.site import Profile  
...
class Location (object): 
    ...
    def __init__(
        ...
        **kwds
        ...
        self._logging = hlearnlog.get_hlearn_logger(
    ...
    def to_utm_in(
        ...
        **kws 
        ...
        kws: dict, 
           Keywords argument passed to :meth:`~hlearn.site.Location.to_utm`. 
    ...
    def to_latlon_in(
        ...
        **kws 
        ...
        kws: dict, 
           Keywords argument passed to :meth:`~hlearn.site.Location.to_latlon`. 
        ...
        See Also
        ------------
        hlearn.site.Location.to_latlon: 
