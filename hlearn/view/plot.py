...
"""
:mod:`~hlearn.view.plot` is a set of plot templates for visualising and 
inspecting the learning models.  It gives a quick depiction for users for 
models visualization and evaluation with : :class:`~hlearn.view.EvalPlot`
"""
...
class EvalPlot(BasePlot): 
    ...
    def fit(self, X: NDArray |DataFrame =None, y:ArrayLike =None, 
        ...
        :class:`hlearn.exceptions.NotFittedError` when a method is called.
        ...
        fit_params: dict Additional keywords arguments from 
            :func:hlearn.utils.coreutils._is_readable`
    ...
    def transform (self, X, **t_params): 
        ...
        t_params: dict, 
            ...
            :func:hlearn.utils.funcutils.to_numeric_dtypes`
    ...
    def plotPCA(
        ...
        pca_kws: dict, 
            ...
            :class:`hlearn.analysis.dimensionality.nPCA`
        ...
        >>> from hlearn.view.mlplot import EvalPlot 
    ...
    def plotPR(
        ...
        **prt_kws
        ...
        prt_kws:dict, 
            Additional keyword arguments passed to 
            func:`hlearn.exlib.sklearn.precision_recall_tradeoff`
        ...
        Examples
        ---------
        >>> from hlearn.exlib.sklearn import SGDClassifier
        >>> from hlearn.datasets.dload import load_bagoue 
        >>> from hlearn.utils import cattarget 
        >>> from hlearn.view.mlplot import EvalPlot 
        >>> X , y = load_bagoue(as_frame =True )
    ...
    def plotConfusionMatrix(
        ...
        **conf_mx_kws
        ...
        >>> from hlearn.utils.mlutils import cattarget 
        >>> from hlearn.exlib.sklearn import SVC 
        >>> from hlearn.view.mlplot import EvalPlot
...
pobj.__doc__="""\
Shadow plotting class that holds the :class:`~hlearn.property.BasePlot`
parameters. 

Each matplotlib properties can be modified as  :class:`~hlearn.view.pobj`
...
.. seealso:: 
    ...
    Refer to :class:`~hlearn.property.BasePlot` for parameter details. 
...
def plotProjection(
    ...
    **baseplot_kws 
    ...
    baseplot_kws: dict, 
        ...
        :class:`hlearn.property.BasePlot` class. 
        
    Examples
    --------
    >>> from hlearn.datasets import fetch_data 
    >>> from hlearn.view.mlplot import plotProjection 
    >>> # Discard all the non-numeric data 
    >>> # then inut numerical data 
    >>> from hlearn.utils import to_numeric_dtypes, naive_imputer
...
def plotModel(
    ...
    **baseplot_kws 
    ...
    >>> from hlearn.exlib.sklearn  import SVC 
    >>> from hlearn.datasets import fetch_data 
    >>> from hlearn.view import plotModel 
    >>> from hlearn.utils.mlutils import split_train_test_by_id
...
--------- 
>>> from hlearn.datasets import fetch_data 
>>> from hlearn.view.mlplot import plot_reg_scoring 
...
>>> from hlearn.exlib.sklearn import SVC 
>>> from hlearn.view.mlplot import plot_model_scores
>>> import numpy as np 
>>> svc_model = SVC() 
...
def plotDendroheat(
    ...
    **kwd
    ...
    method : str, optional, default is {'complete'}
        ...
        for full descriptions in :func:`hlearn.utils.exmath.linkage_matrix`
    ...
    >>> # (1) -> Use random data
    >>> import numpy as np 
    >>> from hlearn.view.mlplot import plotDendroheat
    >>> np.random.seed(123) 
...
def plotDendrogram (
    ...
    **kwd ): 
    ...
    >>> from hlearn.view import plotDendrogram
    >>> data = load_iris () 
    >>> X =data.data[:, :2] 
...
def plotSilhouette (
    ...
    * calculate the silhouette, :math:`s^{(i)}`, as the difference between 
    ...
    >>> from hlearn.view.mlplot import plotSilhouette
...
def _plotSilhouette (X, labels, metric ='euclidean', **kwds ):
    ...
    **kwds : optional keyword parameters
    ...
    See also 
    ---------
    hlearn.utils.plotutils.plot_silhouette: Plot naive silhouette 
...
def plotLearningInspections (
    ...
    **kws 
    ...
    >>> from hlearn.view.mlplot import plotLearningInspections 
...
def plotLearningInspection(
    ...
    ----------
    >>> from hlearn.datasets import fetch_data
    >>> from hlearn.models import p 
    >>> from hlearn.view.mlplot import plotLearningInspection 
...
---------
>>> import numpy as np
>>> from hlearn.view.mlplot import plot_matshow 
>>> matshow_kwargs ={
    'aspect': 'auto',
    'interpolation': None,
   'cmap':'copper_r', 
...
def biPlot(
    ...
    Parameters  
    -----------
    self: :class:`hlearn.property.BasePlot`. 
    ...
    >>> from hlearn.datasets import fetch_data
    >>> from hlearn.view import biPlot, pobj  # pobj is Baseplot instance 
    ...
    and was edited to fit the :term:`hlearn` package API. 
...
def plot2d(
    ...
    **baseplot_kws
    ...
    >>> hlearn.view.mlplot.plot2d (data )
    <AxesSubplot:xlabel='Distance(m)', ylabel='log10(Frequency)[Hz]'>
    >>> hlearn.view.mlplot.plot2d (data_nan ,  plt_style = 'imshow', 
                                  fig_size = (10, 4))
    """
    #xxxxxxxxx update base plot keyword arguments
    for k  in list(baseplot_kws.keys()): 
