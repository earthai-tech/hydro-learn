...
""" 
List of :code:`hlearn` exceptions for warning users. 
"""
...
class StationError(Exception):
    ...
    the`hlearn`_ package or unable to find the station position in the dataset.
    """
    pass
...
class FrequencyError (Exception): 
    """Raises an Exception for wrong given frequencies. `hlearn`_ recomputes 
...
class TopModuleError (Exception): 
    ...
    is used by `hlearn`_ for running successfully. For instance, `scikit_learn`_  
    is the top module for modeling and predition. """
    pass 
class NotFittedError (Exception): 
    """ Raise an Exception if the 'fit' method is not called yet. Note 
    most of `hlearn`_ classes implements 'fit' methods for attributes 
...
class ScikitLearnImportError(Exception ): 
    ...
    :class:`~.hlearn._docstring.scikit_learn_doc` for documentation.  
