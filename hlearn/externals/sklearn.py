...
The module gives a sypnosis of the module suse throughout the hlearn packages. 
The mecanism of importation associates 'exlib' to 'sklearn' like 
`hlearn.exlib.sklearn` to different the estimators classes from scikit and 
...
msg= ("Sckit-learn <'sklearn'> is used throughout the hlearn package especially"
