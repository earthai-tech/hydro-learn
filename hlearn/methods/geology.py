...
def setstructures(self , configfile:str =None , fillna:int =0  ): 
    ...
    .. note:: 
        ...
        'amphibolite', one can use:: 
            ...
            >>> from hlearn.geology import Structures 
            >>> sobj = Structures().fit() 
...
class Structures(GeoBase): 
    ...
    * To get the names of different strutures, write the script below:: 
        ...
        >>> from hlearn.geology.geology import Structures
...
class Structural(GeoBase) :
    ...
    >>> from hlearn.geology import Structural 
    >>> s=Structural().fit() 
    >>> s.boudin_axis.code_ 
    ... 'lsb'
    >>> s.boudin_axis.name_
    ...
    def fit(self, configfile= None , **kwd): 
        ...
        if self.configfile is None: 
            self.configfile =  self.configfile = os.path.join(
                 'hlearn/etc', 'agso_stcodes'.upper() + '.csv' )
