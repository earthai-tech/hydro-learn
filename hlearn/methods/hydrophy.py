...
"""
:mod:`~hlearn.methods.hydro` computes Hydrogeological parameters of aquifer 
...
class HData(ABC):
    ...
    def fit(
        ...
        **fit_params
        ...
        as an items in the data should be: 'layer_thickness' like:: 
            ...
            >>> from hlearn.methods.hydro import HData 
    ...
    def squeeze_data (self, strategy="average", **rs_kws): 
        ...
        rs_kws: dict, 
            ...
            :func:`~hlearn.utils.hydroutils.reduce_samples`
        ...
        if self.sname is None: 
            raise StrataError (
                ...
                " :func:`~hlearn.utils.hydroutils.reduce_samples` for"
                " pure examples.")
...
:class:`~.hlearn.methods.hydro.Logging` instead. 
...
class MXS (HData): 
    ...
    def predictNGA (
        ...
        **NGA_kws
        ...
        return_label: bool,default=False
            ...
            :attr:`hlearn.hydro.MXS.yNGA_`
            
        NGA_kws: dict, 
            keyword argument passed to :func:`hlearn.utils.predict_NGA_labels`
        Returns 
        --------
        ...
        --------
        >>> from hlearn.datasets import load_hlogs 
        >>> from hlearn.methods.hydro import MXS 
    ...
    def makeyMXS (
        ...
        **mxs_kws
        ...
        default_ufunc: bool, 
         ...
         mxs_kws:dict, 
             Additional keyword arguments passed to 
             :func:`~.hlearn.utils.make_MXS_labels`. 
        ...
        if ( 
            ...
            raise AquiferGroupError (
                ...
                " :func:`~.hlearn.utils.predict_NGA_labels` to"
    ...
    def labelSimilarity(
        ...
        **sm_kws
        ...
        sm_kws:dict, 
            Additional keyword arguments passed to 
            :func:`~.hlearn.utils.find_similar_labels`.
...
n_groups : int, default=3
    ...
    Refer to :func:`~hlearn.utils.plot_elbow` or 
    :func:`~.hlearn.view.plotSilhouette` 
    or :func:~.hlearn.view.plotDendrogram` for plotting purpose. 
...
class Logging :
    ...
    ----------
    >>> from hlearn.datasets import load_hlogs 
    >>> from hlearn.methods.hydro import Logging 
...
Example 
--------
>>> from hlearn.methods.hydro import AqGroup 
