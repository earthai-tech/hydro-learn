...
def assert_xy_coordinate_system (x, y ): 
    ...
    >>> import numpy as np 
    >>> np.random.seed (42 ) 
    >>> from hlearn.utils.gistools import assert_xy_coordinate_system
...
def convert_position_str2float(position_str):
    ...
    **position** : float
    ...
    Example
    -------------
    >>> import hlearn.utils.gis_tools as gis_tools
...
#             " hlearn.utils.gistools.project_point_ll2utm() should be "
#             "used instead.")
...
@gdal_data_check
@deprecated("This function may be removed in later release."
            " hlearn.utils.gistools.project_point_utm2ll() should be "
            "used instead.")
