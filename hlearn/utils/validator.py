...
# Copyright (c) 2022 The scikit-learn and hlearn developers.
# All rights reserved.
...
def _validate_tensor( 
    ...
    **kws, 
    ...
    kws: dict 
        ...
        :func:`~hlearn.utils.get_full_frequency`. 
    ...
    Examples 
    ---------
    >>> from hlearn.utils.validator import _validate_tensor 
...
def _assert_z_or_edi_objs ( z_or_edis_obj_list, /): 
    ...
    if len(s_edi) !=1 or False in list(s_edi):
        raise EMError("Expect EDI[hlearn.edi.Edi] or Z[hlearn.externals.z.Z]"
...
def assert_xy_in (
    ...
    **kws  
    ...
    >>> import numpy as np 
    >>> import pandas as pd 
    >>> from hlearn.utils.validator import assert_xy_in 
    ...
    if data is not None: 
        ...
        if not _is_valid_ves(data): 
            raise exception( 
                ...
                " given data. Refer to :class:`~.hlearn._docstring.ves_doc`"
...
def array_to_frame(
    ...
    *, 
    ...
    >>> from hlearn.utils.validator import array_to_frame 
...
def _assert_all_finite(
    ...
    err_msg=(
        ...
        " 'naive_imputer' in 'hlearn.utils.mlutils.naive_imputer'."
        )
