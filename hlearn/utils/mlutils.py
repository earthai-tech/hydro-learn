...
def resampling( 
    ...
    **kws
    ...
    --------- 
    >>> import hlearn as wx 
    >>> from hlearn.utils.mlutils import resampling 
...
def bin_counting(
    ...
    ---------
    >>> import hlearn as wx 
    >>> from hlearn.utils.mlutils import bin_counting 
...
def correlatedfeatures(
    ...
    Examples
    --------
    >>> from hlearn.utils.mlutils import correlatedcolumns 
...
def exporttarget (df, tname, inplace = True): 
    ...
    >>> from hlearn.utils.mlutils import exporttarget 
...
def formatGenericObj(generic_obj :Iterable[T])-> T: 
    ...
    :Example: 
        ...
        >>> from hlearn.utils.mlutils import formatGenericObj 
...
def findIntersectionGenObject(
    ...
    :Example: 
        ...
        >>> from hlearn.utils.mlutils import findIntersectionGenObject
...
def findDifferenceGenObject(gen_obj1: Iterable[Any],
    ...
    :Example: 
        ...
        >>> from hlearn.utils.mlutils import findDifferenceGenObject
...
def controlExistingEstimator(
    ...
    :Example: 
        ...
        >>> from hlearn.utils.mlutils import controlExistingEstimator 
...
def formatModelScore(
    ...
    :Example: 
        ...
        >>> from hlearn.utils.mlutils import formatModelScore 
...
def fetchTGZDatafromURL (
    ...
    **kws
    ...
    :example: 
    >>> from hlearn.utils.mlutils import fetchTGZDatafromURL
    >>> DOWNLOAD_ROOT = 'https://raw.githubusercontent.com/WEgeophysics/hlearn/master/'
...
def fetchSingleTGZData(
    ...
    :Example: 
        >>> from hlearn.utils.mlutils import fetchSingleTGZData
...
def fetch_model(
    ...
    :Example: 
        >>> from hlearn.bases import fetch_model 
...
def loadDumpedOrSerializedData (filename:str, verbose=0): 
    ...
    :Example:
        ...
        >>> from hlearn.utils.mlutils import loadDumpedOrSerializedData
        >>> loadDumpedOrSerializedData(filename ='hlearn/datasets/__XTyT.pkl')
    """
...
def _assert_sl_target (target,  df=None, obj=None): 
    ...
    :Example: 
        ...
        >>> from hlearn.utils.mlutils import _assert_sl_target
        >>> from hlearn.datasets import fetch_data
...
def get_target(
    ...
    >>>> import numpy as np 
    >>> import pandas as pd 
    >>> from hlearn.utils.mtutils import get_target 
...
def findCatandNumFeatures( 
    ...
    ----------
    >>> from hlearn.datasets import fetch_data 
    >>>> from hlearn.tools import findCatandNumFeatures
...
def _cattarget (ar , labels , order=None): 
    """ A shadow function of :func:`hlearn.utils.mlutils.cattarget`. 
...
def bi_selector (d, /,  features =None, return_frames = False ):
    ...
    Example 
    --------
    >>> from hlearn.utils.mlutils import bi_selector 
...
def make_naive_pipe(
    ...
    for_pca:bool, default=False, 
        ...
        ``True``, :class:`hlearn.exlib.sklearn.OrdinalEncoder`` is used insted 
        of :class:`hlearn.exlib.sklearn.OneHotEncoder``. 
    ...
    Returns
    ---------
    full_pipeline: :class:`hlearn.exlib.sklearn.FeatureUnion`
    ...
    >>> from hlearn.exlib.sklearn import RobustScaler 
...
def select_feature_importances (
    ...
    **kws
    ...
    Examples
    --------
    >>> from hlearn.utils.mlutils import select_feature_importances
...
def naive_imputer (
    ...
    **fit_params 
    ...
    >>> import numpy as np 
    >>> import pandas as pd 
    >>> from hlearn.utils.mlutils import naive_imputer 
...
def naive_scaler(
    ...
    **fit_params  
    ...
    >>> import numpy as np  
    >>> import pandas as pd 
    >>> from hlearn.utils.mlutils import naive_scaler 
