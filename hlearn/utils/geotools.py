...
def find_similar_structures(
    ...
    Examples
    ---------
    >>> from hlearn.utils.geotools import find_similar_structures
...
def smart_thickness_ranker ( 
   ...
   verbose: bool, default=False 
    ...
    Examples 
    --------
    >>> from hlearn.utils.geotools import smart_thickness_ranker
...
def get_thick_from_values(
    ...
    Examples
    ---------
    >>> from hlearn.utils.geotools import _parse_only_thick 
...
def get_thick_from_range( 
    ...
    Examples
    ----------
    >>> from hlearn.utils.geotools import get_thick_from_range 
...
def _make_thick_range ( v ,/,  sep='-:' , tostr=True )-> str| list : 
    ...
    Examples
    ---------
    >>> from hlearn.utils.geotools import _make_thick_range 
...
def _thick_range_asserter (
    ...
    Examples 
    ----------
    >>> from hlearn.utils.geotools import _thick_range_asserter
...
def build_random_thickness(
    ...
    Examples
    ---------
    >>> from hlearn.utils.geotools import build_random_thickness 
...
def fit_rocks(logS_array, lns_, tres_):
    ...
    :Example: 
        ...
        >>> import hlearn.utils.geotools as GU
        >>> import hlearn.geology.core as GC 
...
def set_default_hatch_color_values(hatch, color, dhatch='.--', 
    ...
    :Example: 
        >>> from hlearn.utils.geotools as  GU.
        >>> hatch =['//.', 'none', '+++.', None]
...
def display_ginfos(
    ...
    **kws):
    ...
    :Example: 
        >>> from hlearn.geology.stratigraphic import display_infos
