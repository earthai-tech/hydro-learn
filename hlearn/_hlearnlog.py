...
class hlearnlog:
    ...
    def set_logger_output(
        ...
        * level : object, optional
        ...
        logger=hlearnlog.get_watex_logger(__name__) 
...
def test_yaml_configfile(yamlfile="wlog.yml"):
    ...
    hlearnlog.load_configure(UsersOwnConfigFile)
    logger = hlearnlog.get_watex_logger(__name__)
...
if __name__=='__main__':
    ...
    print(os.path.abspath(hlearnlog.__name__))
