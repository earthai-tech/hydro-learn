...
from hlearn.utils import naive_imputer 
...
from hlearn.utils import to_numeric_dtypes  
from hlearn.utils import naive_scaler 
...
from hlearn.utils import plot_pca_components 
...
from hlearn.utils  import make_naive_pipe 
...
from hlearn.utils import plot_clusters 
# %%
...
from hlearn.utils import plot_rf_feature_importances 
...
from hlearn.utils import plot_elbow 
...
from hlearn.view import plotSilhouette 
...
# :func:`~hlearn.view.plotSilhouette` documentation.
...
from hlearn.utils.hydroutils import find_aquifer_groups, classify_k
...
from hlearn.utils import predict_NGA_labels 
...
# :func:`~hlearn.utils.make_MXS_labels` or use the MXS class (:class:`~hlearn.methods.MXS` ) 
# of the module :mod:`~hlearn.methods.hydro`

from hlearn.utils import make_MXS_labels 
